...
class User:
    def __init__(self, name, location, address, contact, interests):
        self.name = name
...
def merge(left: list, right: list):
    ...
    while left_index < len(left) and right_index < len(right):
        if left[left_index][0].lower() < right[right_index][0].lower():
...
class App:
    ...
    def create_main_frame(self):
        ...
        ttk.Label(
            self.main_frame,
            text="Welcome to Customer Registration System",
    ...
    def refresh_customer_list(self):
        ...
        for customer in self.manager.customers:
            self.customer_tree.insert("", "end", values=customer)  # Show all customer details
    ...
    def save_changes(self, item, new_name, new_location, new_address, new_contact, new_interests):
        ...
        self.manager.customers[index][0] = new_name
        self.manager.customers[index][1] = new_location
        self.manager.customers[index][2] = new_address
        self.manager.customers[index][3] = new_contact
        self.manager.customers[index][4] = new_interests

        # Save updated customers list back to the file
        with open('customers_list.json', 'w') as file:
    ...
    def create_search_frame(self):
        ...
        self.search_option = tk.IntVar(value=0)
        ttk.Radiobutton(
            self.search_frame,
            text="Name",
        ...
        if results:
            for customer in results:
                self.search_results.insert(tk.END,
                                           f"Name: {customer[0]}, Location: {customer[1]}, Address: {customer[2]}, Contact: {customer[3]}, Interests: {customer[4]}")
        else:
